...
//     useEffect(() => {
//         const idMatchingVocabularyCard = vocabularies.find(vocabularyCard => vocabularyCard.Id == id);
//         console.log(idMatchingVocabularyCard);

//         setIdMatchingCard(idMatchingVocabularyCard);
//     }, [id, vocabularies])
